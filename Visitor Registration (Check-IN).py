...
def sql_connection():
    if check.check_data_in():
        ...
        try:
            ...
            Q = "INSERT INTO visitors(first_name, last_name, mobile, address, wing, flat, purpose, company_name, cin_date, cin_time, watchman_code) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
